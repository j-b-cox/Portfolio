...
import "./index.css";
import HABProject from "./pages/HABProject.jsx"; // make sure this file exists
    ...
    <nav className="fixed top-0 left-0 w-full bg-white shadow-md z-50">
      <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="space-x-6 hidden md:flex">
          {/* absolute hash-links so they work from any route */}
    ...
    >
      ...
      >
        <a
          ...
          className="px-5 py-3 bg-gray-900 text-white rounded-full shadow hover:bg-gray-700 transition"
        >
          Resume
        </a>
        <a
          href="https://www.linkedin.com/in/jesse-cox-662458ab/"
          target="_blank"
          rel="noopener noreferrer"
          className="px-5 py-3 bg-blue-600 text-white rounded-full shadow hover:bg-blue-700 transition"
        >
          LinkedIn
        </a>
        <a
          href="https://github.com/j-b-cox"
          target="_blank"
          rel="noopener noreferrer"
          className="px-5 py-3 bg-gray-800 text-white rounded-full shadow hover:bg-gray-600 transition"
        >
          GitHub
        </a>
      </motion.div>
        ...
        <Link to="/projects/hab">
          ...
          >
            ...
            <p className="text-gray-600">
              ML models and satellite imagery for forecasting cyanobacteria in Western Lake Erie.
            </p>
          </motion.div>
        </Link>
        ...
        {["Data Dashboard", "AI Research Project"].map((title, i) => (
          <Link key={i} to={`/projects/${title.toLowerCase().replace(/\s+/g, "-")}`}>
            ...
            >
              ...
              <p className="text-gray-600">
                Brief description. Highlight tech, challenges, and impact.
              </p>
            </motion.div>
          </Link>
        ))}
...
function Contact() {
  return (
    <section id="contact" className="py-24 bg-blue-200 px-6 text-center">
      ...
      <motion.a
        href="mailto:jbcox@berkeley.edu"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        viewport={{ once: true }}
